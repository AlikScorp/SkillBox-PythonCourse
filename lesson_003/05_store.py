...
#   Плохо понял вышеуказанный коментарий, но добавил в инициализацию переменных "получение списка на складе"
#   Никаких предупреждений от среды разработки не вижу :-(
